...
GitHub Pages + Supabaseで動く、2人/3人オンライン対戦版の三色じゃんけんです。  
...
2人対戦の場合は、1番手と2番手だけで同じルールを使います。勝った人が次ラウンドの1番手、あいこなら順番維持です。
...
既に旧版を実行済みの場合も、もう一度 `supabase/schema.sql` を実行してください。2人/3人対応用のカラムとマッチング関数が更新されます。
...
- `tcj_try_match()`: 選択した人数がそろったらゲームを作るRPC
...
- 名前と対戦人数を選んで「参加」を押すと待機キューに入る
- 2人対戦を選んだ人は2人対戦同士、3人対戦を選んだ人は3人対戦同士でだけマッチングする
- 待機中の有効プレイヤーが選択人数に達した瞬間にマッチングする
